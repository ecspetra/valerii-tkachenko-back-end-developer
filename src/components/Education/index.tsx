...
const Education = () => (
	<div
		className='relative w-screen min-h-screen py-32 xl:py-60 overflow-hidden flex items-center'
		id='education'
	>
		<Parallax
			translateY={[100, 0]}
			className='w-[200px] h-[250px] 2xl:w-[250px] 2xl:h-[300px] absolute bottom-[30%] right-[5%] 2xl:right-[25%]'
		>
			<Trees variant='v2' />
		</Parallax>
		...
		<div className='container max-w-6xl mx-auto w-full px-6 text-center relative z-10'>
			<div className='mb-28 2xl:mb-40 relative'>
				...
				<Parallax
					translateX={[-20, 20]}
					className='absolute -bottom-12 left-[20%] w-[320px] h-[220px] 2xl:w-[400px] 2xl:h-[300px] -z-10 overflow-hidden'
				>
					<Parallax
						scale={[1, 2]}
				...
				<Mountains className='w-full -bottom-[20%] 2xl:bottom-[140%] left-1/2 -translate-x-1/2' />
